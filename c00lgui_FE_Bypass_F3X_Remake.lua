--[[
	  ...
	  / _ )/ /__  ____/ /____ __/ _ \_______ ____ ____  ___  / // /__ ___ ____/ /
	 / _  / / _ \/ __/  '_/ // / // / __/ _ `/ _ `/ _ \/ _ \/ _  / -_) _ `/ _  / 
	/____/_/\___/\__/_/\_\\_, /____/_/  \_,_/\_, /\___/_//_/_//_/\__/\_,_/\_,_/  
	                     /___/              /___/                                
	script made by BlockyDragonHead --scriptblox.com/u/BlockyDragonHead
	reposted by bossameownova --https://scriptblox.com/u/BossaMeowNova
	
	thanks for using <3
	please like and favorite :3
	
	also idc if you skid my script or not
]]--

local cKav2 = Instance.new("ScreenGui")
...
local decalId = Instance.new("TextLabel")
...
local PageNumber_4 = Instance.new("TextLabel")
local Animations_2 = Instance.new("TextLabel")
local AdminsGuis_2 = Instance.new("TextLabel")
local pres2 = Instance.new("TextButton")
local pres5 = Instance.new("TextButton")
local pres6 = Instance.new("TextButton")
local pres7 = Instance.new("TextButton")
local pres8 = Instance.new("TextButton")
local Empty_11 = Instance.new("TextButton")
local pres9 = Instance.new("TextButton")
local pres10 = Instance.new("TextButton")
local Empty_12 = Instance.new("TextButton")
local Empty_13 = Instance.new("TextButton")
local Empty_14 = Instance.new("TextButton")
local pres1 = Instance.new("TextButton")
local pres3 = Instance.new("TextButton")
local pres4 = Instance.new("TextButton")
local big = Instance.new("TextButton")
local Empty_15 = Instance.new("TextButton")
local bgase = Instance.new("TextButton")
...
local fiyah = Instance.new("TextButton")
local t3am = Instance.new("TextButton")
local ITSRAININGMEN = Instance.new("TextButton")
local Empty_19 = Instance.new("TextButton")
local decalspa = Instance.new("TextButton")
local diediedie = Instance.new("TextButton")
...
cKav2.Name = "cKa v2"
cKav2.Parent = game.CoreGui
cKav2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

ScriptsFrame.Name = "ScriptsFrame"
ScriptsFrame.Parent = cKav2
...
team.Name = "team"
team.Parent = SettingsPage1
team.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
team.BorderColor3 = Color3.fromRGB(255, 0, 0)
team.BorderSizePixel = 3
team.Position = UDim2.new(0.491694361, 0, 0.462000012, 0)
team.Size = UDim2.new(0, 150, 0, 28)
team.Font = Enum.Font.SourceSans
team.Text = "Team Names"
team.TextColor3 = Color3.fromRGB(255, 255, 255)
team.TextSize = 18.000

TextBox_5.Parent = team
TextBox_5.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
TextBox_5.BorderColor3 = Color3.fromRGB(255, 0, 0)
TextBox_5.BorderSizePixel = 3
TextBox_5.Position = UDim2.new(0.00666666683, 0, 1.14285719, 0)
TextBox_5.Size = UDim2.new(0, 149, 0, 28)
TextBox_5.Font = Enum.Font.SourceSans
TextBox_5.PlaceholderText = "lol"
TextBox_5.Text = "Team c00lkidd! Join Today!"
TextBox_5.TextColor3 = Color3.fromRGB(255, 255, 255)
TextBox_5.TextSize = 14.000
TextBox_5.TextWrapped = true

decalId.Name = "decalId"
decalId.Parent = SettingsPage1
decalId.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
decalId.BorderColor3 = Color3.fromRGB(255, 0, 0)
decalId.BorderSizePixel = 3
decalId.Position = UDim2.new(-0.00996677764, 0, 0.462000012, 0)
decalId.Size = UDim2.new(0, 150, 0, 28)
decalId.Font = Enum.Font.SourceSans
decalId.Text = "Decal ID"
decalId.TextColor3 = Color3.fromRGB(255, 255, 255)
decalId.TextSize = 18.000
...
TextBox_6.Position = UDim2.new(0.00666666683, 0, 1.14285719, 0)
TextBox_6.Size = UDim2.new(0, 149, 0, 28)
TextBox_6.Font = Enum.Font.SourceSans
TextBox_6.PlaceholderText = "lol"
...
MainTitle.Text = "c00lgui Reborn FE F3X By goodRc7"
...
ScriptsPage3.Parent = ScriptsFrame
ScriptsPage3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ScriptsPage3.BackgroundTransparency = 1.000
ScriptsPage3.BorderColor3 = Color3.fromRGB(0, 0, 0)
ScriptsPage3.BorderSizePixel = 0
ScriptsPage3.Position = UDim2.new(-0.0132890362, 0, 0.242497236, 0)
ScriptsPage3.Size = UDim2.new(0, 301, 0, 274)
ScriptsPage3.Visible = false

PageNumber_4.Name = "PageNumber"
PageNumber_4.Parent = ScriptsPage3
PageNumber_4.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
PageNumber_4.BorderColor3 = Color3.fromRGB(255, 0, 0)
PageNumber_4.BorderSizePixel = 3
PageNumber_4.Position = UDim2.new(0, 0, 0.876934409, 0)
PageNumber_4.Size = UDim2.new(0, 301, 0, 33)
PageNumber_4.ZIndex = 7
PageNumber_4.Font = Enum.Font.SourceSans
PageNumber_4.Text = "Page 3"
PageNumber_4.TextColor3 = Color3.fromRGB(255, 255, 255)
PageNumber_4.TextSize = 22.000
PageNumber_4.TextWrapped = true

Animations_2.Name = "Animations"
Animations_2.Parent = ScriptsPage3
Animations_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Animations_2.BorderColor3 = Color3.fromRGB(255, 0, 0)
Animations_2.BorderSizePixel = 3
Animations_2.Size = UDim2.new(0, 150, 0, 28)
Animations_2.Font = Enum.Font.SourceSans
Animations_2.Text = "Server Destruction (F3X)"
Animations_2.TextColor3 = Color3.fromRGB(255, 255, 255)
Animations_2.TextScaled = true
Animations_2.TextSize = 18.000
Animations_2.TextWrapped = true

AdminsGuis_2.Name = "Admins/Guis"
AdminsGuis_2.Parent = ScriptsPage3
AdminsGuis_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
AdminsGuis_2.BorderColor3 = Color3.fromRGB(255, 0, 0)
AdminsGuis_2.BorderSizePixel = 3
AdminsGuis_2.Position = UDim2.new(0.514916897, 0, 0, 0)
AdminsGuis_2.Size = UDim2.new(0, 145, 0, 28)
AdminsGuis_2.Font = Enum.Font.SourceSans
AdminsGuis_2.Text = "Preset Decal/Skybox ID's"
AdminsGuis_2.TextColor3 = Color3.fromRGB(255, 255, 255)
AdminsGuis_2.TextSize = 17.000

pres2.Name = "pres2"
pres2.Parent = ScriptsPage3
pres2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres2.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres2.BorderSizePixel = 3
pres2.Position = UDim2.new(0.760508299, 0, 0.110000052, 0)
pres2.Size = UDim2.new(0, 71, 0, 30)
pres2.Font = Enum.Font.SourceSans
pres2.Text = "BlockyDragonHead"
pres2.TextColor3 = Color3.fromRGB(255, 255, 255)
pres2.TextScaled = true
pres2.TextSize = 17.000
pres2.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres2.TextStrokeTransparency = 3.000
pres2.TextWrapped = true

pres5.Name = "pres5"
pres5.Parent = ScriptsPage3
pres5.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres5.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres5.BorderSizePixel = 3
pres5.Position = UDim2.new(0.508016586, 0, 0.328978151, 0)
pres5.Size = UDim2.new(0, 71, 0, 30)
pres5.Font = Enum.Font.SourceSans
pres5.Text = "Skeletons"
pres5.TextColor3 = Color3.fromRGB(255, 255, 255)
pres5.TextScaled = true
pres5.TextSize = 17.000
pres5.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres5.TextStrokeTransparency = 3.000
pres5.TextWrapped = true

pres6.Name = "pres6"
pres6.Parent = ScriptsPage3
pres6.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres6.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres6.BorderSizePixel = 3
pres6.Position = UDim2.new(0.757186055, 0, 0.328978151, 0)
pres6.Size = UDim2.new(0, 71, 0, 30)
pres6.Font = Enum.Font.SourceSans
pres6.Text = "Nado"
pres6.TextColor3 = Color3.fromRGB(255, 255, 255)
pres6.TextScaled = true
pres6.TextSize = 17.000
pres6.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres6.TextStrokeTransparency = 3.000
pres6.TextWrapped = true

pres7.Name = "pres7"
pres7.Parent = ScriptsPage3
pres7.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres7.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres7.BorderSizePixel = 3
pres7.Position = UDim2.new(0.508016586, 0, 0.438978106, 0)
pres7.Size = UDim2.new(0, 71, 0, 30)
pres7.Font = Enum.Font.SourceSans
pres7.Text = "Sonic"
pres7.TextColor3 = Color3.fromRGB(255, 255, 255)
pres7.TextScaled = true
pres7.TextSize = 17.000
pres7.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres7.TextStrokeTransparency = 3.000
pres7.TextWrapped = true

pres8.Name = "pres8"
pres8.Parent = ScriptsPage3
pres8.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres8.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres8.BorderSizePixel = 3
pres8.Position = UDim2.new(0.757186055, 0, 0.438467205, 0)
pres8.Size = UDim2.new(0, 71, 0, 30)
pres8.ZIndex = 3
pres8.Font = Enum.Font.SourceSans
pres8.Text = "Poob"
pres8.TextColor3 = Color3.fromRGB(255, 255, 255)
pres8.TextScaled = true
pres8.TextSize = 17.000
pres8.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres8.TextStrokeTransparency = 3.000
pres8.TextWrapped = true

Empty_11.Name = "Empty"
Empty_11.Parent = ScriptsPage3
Empty_11.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_11.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_11.BorderSizePixel = 3
Empty_11.Position = UDim2.new(0.504694343, 0, 0.657956302, 0)
Empty_11.Size = UDim2.new(0, 71, 0, 30)
Empty_11.Font = Enum.Font.SourceSans
Empty_11.Text = "Empty"
Empty_11.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_11.TextScaled = true
Empty_11.TextSize = 17.000
Empty_11.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_11.TextStrokeTransparency = 3.000
Empty_11.TextWrapped = true

pres9.Name = "pres9"
pres9.Parent = ScriptsPage3
pres9.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres9.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres9.BorderSizePixel = 3
pres9.Position = UDim2.new(0.504694343, 0, 0.547956228, 0)
pres9.Size = UDim2.new(0, 71, 0, 30)
pres9.Font = Enum.Font.SourceSans
pres9.Text = "I LIVE"
pres9.TextColor3 = Color3.fromRGB(255, 255, 255)
pres9.TextScaled = true
pres9.TextSize = 17.000
pres9.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres9.TextStrokeTransparency = 3.000
pres9.TextWrapped = true

pres10.Name = "pres10"
pres10.Parent = ScriptsPage3
pres10.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres10.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres10.BorderSizePixel = 3
pres10.Position = UDim2.new(0.757186055, 0, 0.547956228, 0)
pres10.Size = UDim2.new(0, 71, 0, 30)
pres10.ZIndex = 5
pres10.Font = Enum.Font.SourceSans
pres10.Text = "Mario EXE"
pres10.TextColor3 = Color3.fromRGB(255, 255, 255)
pres10.TextScaled = true
pres10.TextSize = 17.000
pres10.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres10.TextStrokeTransparency = 3.000
pres10.TextWrapped = true

Empty_12.Name = "Empty"
Empty_12.Parent = ScriptsPage3
Empty_12.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_12.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_12.BorderSizePixel = 3
Empty_12.Position = UDim2.new(0.757186055, 0, 0.657445312, 0)
Empty_12.Size = UDim2.new(0, 71, 0, 30)
Empty_12.ZIndex = 3
Empty_12.Font = Enum.Font.SourceSans
Empty_12.Text = "Empty"
Empty_12.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_12.TextScaled = true
Empty_12.TextSize = 17.000
Empty_12.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_12.TextStrokeTransparency = 3.000
Empty_12.TextWrapped = true

Empty_13.Name = "Empty"
Empty_13.Parent = ScriptsPage3
Empty_13.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_13.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_13.BorderSizePixel = 3
Empty_13.Position = UDim2.new(0.508016586, 0, 0.767445385, 0)
Empty_13.Size = UDim2.new(0, 71, 0, 30)
Empty_13.Font = Enum.Font.SourceSans
Empty_13.Text = "Empty"
Empty_13.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_13.TextScaled = true
Empty_13.TextSize = 17.000
Empty_13.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_13.TextStrokeTransparency = 3.000
Empty_13.TextWrapped = true

Empty_14.Name = "Empty"
Empty_14.Parent = ScriptsPage3
Empty_14.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_14.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_14.BorderSizePixel = 3
Empty_14.Position = UDim2.new(0.760508299, 0, 0.766934335, 0)
Empty_14.Size = UDim2.new(0, 71, 0, 30)
Empty_14.ZIndex = 3
Empty_14.Font = Enum.Font.SourceSans
Empty_14.Text = "Empty"
Empty_14.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_14.TextScaled = true
Empty_14.TextSize = 17.000
Empty_14.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_14.TextStrokeTransparency = 3.000
Empty_14.TextWrapped = true

pres1.Name = "pres1"
pres1.Parent = ScriptsPage3
pres1.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres1.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres1.BorderSizePixel = 3
pres1.Position = UDim2.new(0.51133883, 0, 0.110000052, 0)
pres1.Size = UDim2.new(0, 71, 0, 30)
pres1.Font = Enum.Font.SourceSans
pres1.Text = "c00lkidd"
pres1.TextColor3 = Color3.fromRGB(255, 255, 255)
pres1.TextScaled = true
pres1.TextSize = 17.000
pres1.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres1.TextStrokeTransparency = 3.000
pres1.TextWrapped = true

pres3.Name = "pres3"
pres3.Parent = ScriptsPage3
pres3.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres3.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres3.BorderSizePixel = 3
pres3.Position = UDim2.new(0.51133883, 0, 0.219999999, 0)
pres3.Size = UDim2.new(0, 71, 0, 30)
pres3.Font = Enum.Font.SourceSans
pres3.Text = "skoob"
pres3.TextColor3 = Color3.fromRGB(255, 255, 255)
pres3.TextScaled = true
pres3.TextSize = 17.000
pres3.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres3.TextStrokeTransparency = 3.000
pres3.TextWrapped = true

pres4.Name = "pres4"
pres4.Parent = ScriptsPage3
pres4.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
pres4.BorderColor3 = Color3.fromRGB(255, 0, 0)
pres4.BorderSizePixel = 3
pres4.Position = UDim2.new(0.760508299, 0, 0.219489098, 0)
pres4.Size = UDim2.new(0, 71, 0, 30)
pres4.Font = Enum.Font.SourceSans
pres4.Text = "John"
pres4.TextColor3 = Color3.fromRGB(255, 255, 255)
pres4.TextScaled = true
pres4.TextSize = 17.000
pres4.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
pres4.TextStrokeTransparency = 3.000
pres4.TextWrapped = true

big.Name = "big"
big.Parent = ScriptsPage3
big.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
big.BorderColor3 = Color3.fromRGB(255, 0, 0)
big.BorderSizePixel = 3
big.Position = UDim2.new(0.00967772212, 0, 0.438978106, 0)
big.Size = UDim2.new(0, 71, 0, 30)
big.Font = Enum.Font.SourceSans
big.Text = "Big Head All"
big.TextColor3 = Color3.fromRGB(255, 255, 255)
big.TextScaled = true
big.TextSize = 17.000
big.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
big.TextStrokeTransparency = 3.000
big.TextWrapped = true

Empty_15.Name = "Empty"
Empty_15.Parent = ScriptsPage3
Empty_15.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_15.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_15.BorderSizePixel = 3
Empty_15.Position = UDim2.new(0.258847266, 0, 0.547956228, 0)
Empty_15.Size = UDim2.new(0, 71, 0, 30)
Empty_15.ZIndex = 5
Empty_15.Font = Enum.Font.SourceSans
Empty_15.Text = "Empty"
Empty_15.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_15.TextScaled = true
Empty_15.TextSize = 17.000
Empty_15.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_15.TextStrokeTransparency = 3.000
Empty_15.TextWrapped = true

bgase.Name = "bgase"
bgase.Parent = ScriptsPage3
bgase.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
bgase.BorderColor3 = Color3.fromRGB(255, 0, 0)
bgase.BorderSizePixel = 3
bgase.Position = UDim2.new(0.00635546306, 0, 0.547956228, 0)
bgase.Size = UDim2.new(0, 71, 0, 30)
bgase.Font = Enum.Font.SourceSans
bgase.Text = "Baseplate"
bgase.TextColor3 = Color3.fromRGB(255, 255, 255)
bgase.TextScaled = true
bgase.TextSize = 17.000
bgase.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
bgase.TextStrokeTransparency = 3.000
bgase.TextWrapped = true

Empty_16.Name = "Empty"
Empty_16.Parent = ScriptsPage3
Empty_16.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_16.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_16.BorderSizePixel = 3
Empty_16.Position = UDim2.new(0.258847266, 0, 0.657445312, 0)
Empty_16.Size = UDim2.new(0, 71, 0, 30)
Empty_16.ZIndex = 3
Empty_16.Font = Enum.Font.SourceSans
Empty_16.Text = "Empty"
Empty_16.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_16.TextScaled = true
Empty_16.TextSize = 17.000
Empty_16.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_16.TextStrokeTransparency = 3.000
Empty_16.TextWrapped = true

Empty_17.Name = "Empty"
Empty_17.Parent = ScriptsPage3
Empty_17.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_17.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_17.BorderSizePixel = 3
Empty_17.Position = UDim2.new(0.262169421, 0, 0.766934335, 0)
Empty_17.Size = UDim2.new(0, 71, 0, 30)
Empty_17.ZIndex = 3
Empty_17.Font = Enum.Font.SourceSans
Empty_17.Text = "Empty"
Empty_17.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_17.TextScaled = true
Empty_17.TextSize = 17.000
Empty_17.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_17.TextStrokeTransparency = 3.000
Empty_17.TextWrapped = true

Empty_18.Name = "Empty"
Empty_18.Parent = ScriptsPage3
Empty_18.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_18.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_18.BorderSizePixel = 3
Empty_18.Position = UDim2.new(0.00967772212, 0, 0.767445385, 0)
Empty_18.Size = UDim2.new(0, 71, 0, 30)
Empty_18.Font = Enum.Font.SourceSans
Empty_18.Text = "Empty"
Empty_18.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_18.TextScaled = true
Empty_18.TextSize = 17.000
Empty_18.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_18.TextStrokeTransparency = 3.000
Empty_18.TextWrapped = true

troll.Name = "troll"
troll.Parent = ScriptsPage3
troll.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
troll.BorderColor3 = Color3.fromRGB(255, 0, 0)
troll.BorderSizePixel = 3
troll.Position = UDim2.new(0.00967772212, 0, 0.328978151, 0)
troll.Size = UDim2.new(0, 71, 0, 30)
troll.Font = Enum.Font.SourceSans
troll.Text = "Troll Rain"
troll.TextColor3 = Color3.fromRGB(255, 255, 255)
troll.TextScaled = true
troll.TextSize = 17.000
troll.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
troll.TextStrokeTransparency = 3.000
troll.TextWrapped = true

Sky.Name = "Sky"
Sky.Parent = ScriptsPage3
Sky.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Sky.BorderColor3 = Color3.fromRGB(255, 0, 0)
Sky.BorderSizePixel = 3
Sky.Position = UDim2.new(0.262169421, 0, 0.110000052, 0)
Sky.Size = UDim2.new(0, 71, 0, 30)
Sky.Font = Enum.Font.SourceSans
Sky.Text = "Sky"
Sky.TextColor3 = Color3.fromRGB(255, 255, 255)
Sky.TextScaled = true
Sky.TextSize = 17.000
Sky.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Sky.TextStrokeTransparency = 3.000
Sky.TextWrapped = true

fiyah.Name = "fiyah"
fiyah.Parent = ScriptsPage3
fiyah.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
fiyah.BorderColor3 = Color3.fromRGB(255, 0, 0)
fiyah.BorderSizePixel = 3
fiyah.Position = UDim2.new(0.258847266, 0, 0.328978151, 0)
fiyah.Size = UDim2.new(0, 71, 0, 30)
fiyah.Font = Enum.Font.SourceSans
fiyah.Text = "Kill All"
fiyah.TextColor3 = Color3.fromRGB(255, 255, 255)
fiyah.TextScaled = true
fiyah.TextSize = 17.000
fiyah.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
fiyah.TextStrokeTransparency = 3.000
fiyah.TextWrapped = true

t3am.Name = "t3am"
t3am.Parent = ScriptsPage3
t3am.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
t3am.BorderColor3 = Color3.fromRGB(255, 0, 0)
t3am.BorderSizePixel = 3
t3am.Position = UDim2.new(0.262169421, 0, 0.219489098, 0)
t3am.Size = UDim2.new(0, 71, 0, 30)
t3am.Font = Enum.Font.SourceSans
t3am.Text = "Team Spam"
t3am.TextColor3 = Color3.fromRGB(255, 255, 255)
t3am.TextScaled = true
t3am.TextSize = 17.000
t3am.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
t3am.TextStrokeTransparency = 3.000
t3am.TextWrapped = true

ITSRAININGMEN.Name = "ITSRAININGMEN"
ITSRAININGMEN.Parent = ScriptsPage3
ITSRAININGMEN.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
ITSRAININGMEN.BorderColor3 = Color3.fromRGB(255, 0, 0)
ITSRAININGMEN.BorderSizePixel = 3
ITSRAININGMEN.Position = UDim2.new(0.0129999816, 0, 0.219999999, 0)
ITSRAININGMEN.Size = UDim2.new(0, 71, 0, 30)
ITSRAININGMEN.Font = Enum.Font.SourceSans
ITSRAININGMEN.Text = "Toad rain"
ITSRAININGMEN.TextColor3 = Color3.fromRGB(255, 255, 255)
ITSRAININGMEN.TextScaled = true
ITSRAININGMEN.TextSize = 17.000
ITSRAININGMEN.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
ITSRAININGMEN.TextStrokeTransparency = 3.000
ITSRAININGMEN.TextWrapped = true

Empty_19.Name = "Empty"
Empty_19.Parent = ScriptsPage3
Empty_19.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Empty_19.BorderColor3 = Color3.fromRGB(255, 0, 0)
Empty_19.BorderSizePixel = 3
Empty_19.Position = UDim2.new(0.00635546306, 0, 0.657956302, 0)
Empty_19.Size = UDim2.new(0, 71, 0, 30)
Empty_19.Font = Enum.Font.SourceSans
Empty_19.Text = "Empty"
Empty_19.TextColor3 = Color3.fromRGB(255, 255, 255)
Empty_19.TextScaled = true
Empty_19.TextSize = 17.000
Empty_19.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
Empty_19.TextStrokeTransparency = 3.000
Empty_19.TextWrapped = true

decalspa.Name = "decalspa"
decalspa.Parent = ScriptsPage3
decalspa.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
decalspa.BorderColor3 = Color3.fromRGB(255, 0, 0)
decalspa.BorderSizePixel = 3
decalspa.Position = UDim2.new(0.0129999816, 0, 0.110000052, 0)
decalspa.Size = UDim2.new(0, 71, 0, 30)
decalspa.Font = Enum.Font.SourceSans
decalspa.Text = "Decal Spam"
decalspa.TextColor3 = Color3.fromRGB(255, 255, 255)
decalspa.TextScaled = true
decalspa.TextSize = 17.000
decalspa.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
decalspa.TextStrokeTransparency = 3.000
decalspa.TextWrapped = true

diediedie.Name = "diediedie"
diediedie.Parent = ScriptsPage3
diediedie.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
diediedie.BorderColor3 = Color3.fromRGB(255, 0, 0)
diediedie.BorderSizePixel = 3
diediedie.Position = UDim2.new(0.258847266, 0, 0.438467205, 0)
diediedie.Size = UDim2.new(0, 71, 0, 30)
diediedie.ZIndex = 3
diediedie.Font = Enum.Font.SourceSans
diediedie.Text = "Unanchor"
diediedie.TextColor3 = Color3.fromRGB(255, 255, 255)
diediedie.TextScaled = true
diediedie.TextSize = 17.000
diediedie.TextStrokeColor3 = Color3.fromRGB(255, 0, 0)
diediedie.TextStrokeTransparency = 3.000
diediedie.TextWrapped = true

CloseOpen.Name = "Close/Open"
CloseOpen.Parent = cKav2
...
local function OSFESM_fake_script() -- TextBox.LocalScript 
...
coroutine.wrap(OSFESM_fake_script)()
local function CCZHTMR_fake_script() -- TextBox_2.LocalScript 
...
coroutine.wrap(CCZHTMR_fake_script)()
local function NDHWWQ_fake_script() -- TextBox_3.LocalScript 
...
coroutine.wrap(NDHWWQ_fake_script)()
local function NUMZ_fake_script() -- TextBox_4.LocalScript 
...
coroutine.wrap(NUMZ_fake_script)()
local function EGOGL_fake_script() -- TextBox_5.LocalScript 
	local script = Instance.new('LocalScript', TextBox_5)

	script.Parent.Text = "team c00lkidd join today!"
	local textBox = script.Parent
...
coroutine.wrap(EGOGL_fake_script)()
local function ILQEVPY_fake_script() -- TextBox_6.LocalScript 
	local script = Instance.new('LocalScript', TextBox_6)

	script.Parent.Text = "158118263"
	local textBox = script.Parent
...
coroutine.wrap(ILQEVPY_fake_script)()
local function IVUAXH_fake_script() -- Left_2.LocalScript 
	...
	local page3 = script.Parent.Parent.ScriptsPage3
...
coroutine.wrap(IVUAXH_fake_script)()
local function VTNVNID_fake_script() -- Right_2.LocalScript 
...
coroutine.wrap(VTNVNID_fake_script)()
local function EYKTXW_fake_script() -- JP.LocalScript 
...
coroutine.wrap(EYKTXW_fake_script)()
local function HYBHG_fake_script() -- Fling.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if not Welcome then print("o_o") end
...
coroutine.wrap(HYBHG_fake_script)()
local function AXVBI_fake_script() -- Pad.LocalScript 
...
coroutine.wrap(AXVBI_fake_script)()
local function UBOKHA_fake_script() -- Antifling.LocalScript 
...
coroutine.wrap(UBOKHA_fake_script)()
local function ZIKR_fake_script() -- meme.LocalScript 
...
coroutine.wrap(ZIKR_fake_script)()
local function SIFTOYP_fake_script() -- Suicide.LocalScript 
...
coroutine.wrap(SIFTOYP_fake_script)()
local function AVVRLWX_fake_script() -- BackFlip.LocalScript 
...
coroutine.wrap(AVVRLWX_fake_script)()
local function TDED_fake_script() -- BALLZ.LocalScript 
...
coroutine.wrap(TDED_fake_script)()
local function VPWAE_fake_script() -- Fly.LocalScript 
...
coroutine.wrap(VPWAE_fake_script)()
local function PFOQ_fake_script() -- Walkspeed.LocalScript 
...
coroutine.wrap(PFOQ_fake_script)()
local function KQDNRHO_fake_script() -- Space.LocalScript 
...
coroutine.wrap(KQDNRHO_fake_script)()
local function HJAF_fake_script() -- Skydive.LocalScript 
	local script = Instance.new('LocalScript', Skydive)

	warn("UNDER CONSTRUCTION")
end
coroutine.wrap(HJAF_fake_script)()
local function SQYMIMA_fake_script() -- Nameless.LocalScript 
...
coroutine.wrap(SQYMIMA_fake_script)()
local function XOVR_fake_script() -- Elysian.LocalScript 
...
coroutine.wrap(XOVR_fake_script)()
local function AKGWR_fake_script() -- RC7.LocalScript 
	local script = Instance.new('LocalScript', RC7)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Tool-give-FE-Remake-by-goodRc7-30114"))()
	end)
end
coroutine.wrap(AKGWR_fake_script)()
local function HGOO_fake_script() -- Sex.LocalScript 
...
coroutine.wrap(HGOO_fake_script)()
local function FIIKSP_fake_script() -- Wedge.LocalScript 
...
coroutine.wrap(FIIKSP_fake_script)()
local function SBVO_fake_script() -- ChaosGui.LocalScript 
...
coroutine.wrap(SBVO_fake_script)()
local function RTBFUMA_fake_script() -- Cloudy.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
	    ...
	    --// â˜… Everything made by BlockyDragonHead
	    --// â˜… I don't care if you skid
...
coroutine.wrap(RTBFUMA_fake_script)()
local function HAXJ_fake_script() -- Rzer.LocalScript 
...
coroutine.wrap(HAXJ_fake_script)()
local function DPIVMT_fake_script() -- InfYield.LocalScript 
...
coroutine.wrap(DPIVMT_fake_script)()
local function UIAG_fake_script() -- Rock4usAdmin.LocalScript 
...
local function GOYK_fake_script() -- Dex.LocalScript 
	local script = Instance.new('LocalScript', Dex)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-F3X-gui-Remake-by-goodRc7-is-Remake-30190"))()
	end)
end
coroutine.wrap(GOYK_fake_script)()
local function YVLWRMG_fake_script() -- ShapeShifter.LocalScript 
...
coroutine.wrap(YVLWRMG_fake_script)()
local function KJCE_fake_script() -- GaleFighter.LocalScript 
...
coroutine.wrap(KJCE_fake_script)()
local function YRGUOK_fake_script() -- Classic.LocalScript 
...
coroutine.wrap(YRGUOK_fake_script)()
local function IKRZMBY_fake_script() -- MemeDancer.LocalScript 
...
coroutine.wrap(IKRZMBY_fake_script)()
local function QFGQZ_fake_script() -- Dash.LocalScript 
...
coroutine.wrap(QFGQZ_fake_script)()
local function VPHKV_fake_script() -- DepressedLMAO.LocalScript 
...
coroutine.wrap(VPHKV_fake_script)()
local function FTYWD_fake_script() -- Sonic.LocalScript 
...
coroutine.wrap(FTYWD_fake_script)()
local function OZRLLM_fake_script() -- ButitiOffender.LocalScript 
...
coroutine.wrap(OZRLLM_fake_script)()
local function MEKVUK_fake_script() -- Silly.LocalScript 
...
coroutine.wrap(MEKVUK_fake_script)()
local function KYCG_fake_script() -- ScriptsFrame.LocalScript 
	...
	script.Parent.ScriptsPage3.Visible = false
	script.Parent.p1.Name = "p1"
end
coroutine.wrap(KYCG_fake_script)()
local function EPAFVY_fake_script() -- pres2.LocalScript 
	local script = Instance.new('LocalScript', pres2)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "135607409612252"
	end)
end
coroutine.wrap(EPAFVY_fake_script)()
local function VJJHTMA_fake_script() -- pres5.LocalScript 
	local script = Instance.new('LocalScript', pres5)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "387389871"
	end)
end
coroutine.wrap(VJJHTMA_fake_script)()
local function VWCSYGY_fake_script() -- pres6.waiting 
	local script = Instance.new('LocalScript', pres6)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "131920287538770"
	end)
end
coroutine.wrap(VWCSYGY_fake_script)()
local function DLDL_fake_script() -- pres7.LocalScript 
	local script = Instance.new('LocalScript', pres7)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "6525617772"
	end)
end
coroutine.wrap(DLDL_fake_script)()
local function UQQPQV_fake_script() -- pres8.LocalScript 
	local script = Instance.new('LocalScript', pres8)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "4499704619"
	end)
end
coroutine.wrap(UQQPQV_fake_script)()
local function VFGCTH_fake_script() -- pres9.LocalScript 
	local script = Instance.new('LocalScript', pres9)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "98921419431772"
	end)
end
coroutine.wrap(VFGCTH_fake_script)()
local function ZSZFTH_fake_script() -- pres10.LocalScript 
	local script = Instance.new('LocalScript', pres10)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "131920287538770"
	end)
end
coroutine.wrap(ZSZFTH_fake_script)()
local function ATQI_fake_script() -- pres1.LocalScript 
	local script = Instance.new('LocalScript', pres1)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "158118263"
	end)
end
coroutine.wrap(ATQI_fake_script)()
local function YZCWRE_fake_script() -- pres3.LocalScript 
	local script = Instance.new('LocalScript', pres3)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "6811787912"
	end)
end
coroutine.wrap(YZCWRE_fake_script)()
local function DWPCR_fake_script() -- pres4.LocalScript 
	local script = Instance.new('LocalScript', pres4)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text = "81900375636046"
	end)
end
coroutine.wrap(DWPCR_fake_script)()
local function BYGXB_fake_script() -- big.LocalScript 
...
coroutine.wrap(BYGXB_fake_script)()
local function THRSDV_fake_script() -- bgase.LocalScript 
	local script = Instance.new('LocalScript', bgase)
...
coroutine.wrap(THRSDV_fake_script)()
local function TVIRY_fake_script() -- troll.LocalScript 
...
coroutine.wrap(TVIRY_fake_script)()
local function ONIME_fake_script() -- Sky.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
		...
		Sky(script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text)
	end)
end
coroutine.wrap(ONIME_fake_script)()
local function GBRABX_fake_script() -- fiyah.LocalScript 
	local script = Instance.new('LocalScript', fiyah)
...
coroutine.wrap(GBRABX_fake_script)()
local function YVXDGOV_fake_script() -- t3am.LocalScript 
	local script = Instance.new('LocalScript', t3am)

	script.Parent.MouseButton1Click:Connect(function()
		local msg = script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.team.TextBox.Text
		local replicatedStorage = game.ReplicatedStorage
		if replicatedStorage:FindFirstChild("HDAdminClient") then
			local requestCommand = replicatedStorage.HDAdminClient.Signals:FindFirstChild("RequestCommand")
			if requestCommand then
				-- Execute the Team Spam Commands
				local teamCommands = {
					";createteam bk "..msg.." ",
					";createteam white "..msg.." ",
					";createteam o "..msg.." ",
					";createteam db "..msg.." ",
					";createteam red "..msg.." ",
					";createteam blue "..msg.." ",
					";createteam green "..msg.." ",
					";createteam yellow "..msg.." ",
					";createteam dg "..msg.." ",
					";createteam pink "..msg.." ",
					";createteam p "..msg.." ",
				}
				for _, command in ipairs(teamCommands) do
					requestCommand:InvokeServer(command)
				end
			else
				warn("RequestCommand not found!")
			end
		else
			warn("HDAdminClient not found!")
		end
	end)
end
coroutine.wrap(YVXDGOV_fake_script)()
local function VLFHBY_fake_script() -- ITSRAININGMEN.LocalScript 
	local script = Instance.new('LocalScript', ITSRAININGMEN)
...
coroutine.wrap(VLFHBY_fake_script)()
local function RTND_fake_script() -- decalspa.LocalScript 
	local script = Instance.new('LocalScript', decalspa)
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		spam(script.Parent.Parent.Parent.SettingsFrame.SettingsPage1.decalId.TextBox.Text)
	
	end)
end
coroutine.wrap(RTND_fake_script)()
local function ABDA_fake_script() -- diediedie.LocalScript 
	local script = Instance.new('LocalScript', diediedie)
...
coroutine.wrap(ABDA_fake_script)()
local function XYNS_fake_script() -- CloseOpen.LocalScript 
...
coroutine.wrap(XYNS_fake_script)()
-- BUGS.LocalScript is disabled.
local function JGMOO_fake_script() -- cKav2.MSG 
	local script = Instance.new('LocalScript', cKav2)

	if script.Parent.Enabled == true then
	local m = Instance.new("Message", game.Workspace)
	m.Text = "c00lgui v.2 Loaded..."
	wait(3)
	m:Destroy()
	script:Destroy()
	else
...
coroutine.wrap(JGMOO_fake_script)()
