...
local title = Instance.new("TextLabel")
	...
	title.Text = "c00lgui edit v3 by verfide"
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Music ID"].TextBox.Text = 72089843969979	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = pmi
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
		frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 118050633335508
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
